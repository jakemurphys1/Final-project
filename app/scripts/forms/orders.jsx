...
var allOrders = this.state.allOrders.sort(myAbcSort);
    ...
    return(
      ...
      <div className="row instructions">
        <div className="col-md-2 col-md-offset-1 col-sm-4 col-xs-6 instructionContainer"><h4>Step One:</h4><p>Receive a list of cards from customer. These cards will be from the cards you entered under the "Add Cards to Sale" tab. Remove the cards that are not available by clicking the <span className="removeOrder">X</span> next to the card.</p></div>
        <div className="col-md-2 col-sm-4 col-xs-6 instructionContainer"><h4>Step Two:</h4><p>Calculate the price you are willing to sell those cards and type it into "Price" field for order. Click "Send" to send the price information back to the customer. Wait for reply.</p></div>
